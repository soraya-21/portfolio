...
export const QUOTES_DB = {
    'love': [
        ...
        { text: "On ne voit bien qu'avec le cœur. L'essentiel est invisible pour les yeux.", author: "Le Petit Prince" },
        ...
        { text: "L'amour est un secret entre deux cœurs, un mystère entre deux âmes.", author: "Anonyme" },
        { text: "Le cœur a ses raisons que la raison ne connaît point.", author: "Blaise Pascal" },
        { text: "Aimer, c'est donner rendez-vous au bonheur dans le palais du hasard.", author: "Abel Bonnard" }
    ],
    'courage': [
        ...
        { text: "Quoi que vous fassiez, faites-le avec audace.", author: "George Bernard Shaw" },
        { text: "L'avenir appartient à ceux qui luttent.", author: "Victor Hugo" },
        ...
        { text: "L'audace a du génie, du pouvoir et de la magie.", author: "Goethe" },
    ...
    'time': [
        ...
        { text: "Le temps que tu perds pour ta rose fait ta rose si importante.", author: "Antoine de Saint-Exupéry" },
        { text: "Les deux plus puissants guerriers sont la patience et le temps.", author: "Léon Tolstoï" },
        { text: "Le temps est la matière dont la vie est faite.", author: "Benjamin Franklin" },
        { text: "On ne possède pas le temps, on ne fait que le traverser.", author: "Proverbe arabe" },
        { text: "Chaque instant est un nouveau départ.", author: "T.S. Eliot" },
        { text: "Le temps est un fleuve qui ne remonte jamais vers sa source.", author: "Rivarol" },
        { text: "Perdre son temps, c'est mourir un peu.", author: "Anonyme" },
        { text: "Ne comptez pas les jours, faites que chaque jour compte.", author: "Mohamed Ali" }
    ],
    'success': [
        ...
        { text: "Il n'y a pas de réussite facile, ni de bonheur sans effort.", author: "Jean d'Ormesson" },
        { text: "Tout est possible à qui rêve, ose, travaille et n'abandonne jamais.", author: "Xavier Dolan" },
        { text: "La chance est ce qui arrive quand la préparation rencontre l'opportunité.", author: "Sénèque" },
    ...
    'wisdom': [
        ...
        { text: "Le plus grand voyageur est celui qui a su faire une fois le tour de lui-même.", author: "Confucius" },
        { text: "On n'est pas sage parce qu'on sait beaucoup de choses.", author: "Épictète" },
        { text: "La patience est la racine de toute sagesse.", author: "Platon" },
        { text: "Rien n'est permanent, sauf le changement.", author: "Héraclite" },
        { text: "Mieux vaut une tête bien faite qu'une tête bien pleine.", author: "Montaigne" },
    ...
    'nature': [
        ...
        { text: "La nature est un temple où de vivants piliers laissent parfois sortir de confuses paroles.", author: "Charles Baudelaire" },
        { text: "La terre n'est pas un don de nos parents, ce sont nos enfants qui nous la prêtent.", author: "Proverbe amérindien" },
        { text: "La nature est l'art de Dieu.", author: "Dante" },
        { text: "La nature offre à la fois la nourriture et le spectacle.", author: "Anonyme" },
        { text: "Celui qui plante un arbre, plante un espoir.", author: "Lucy Larcom" },
        { text: "Dans chaque promenade avec la nature, on reçoit beaucoup plus que ce que l'on cherche.", author: "John Muir" },
        { text: "La nature se suffit à elle-même.", author: "Friedrich Hegel" },
        { text: "Pour dominer la nature, il faut lui obéir.", author: "Francis Bacon" }
    ],
    'happiness': [
        ...
        { text: "Le bonheur, c'est lorsque ce que vous pensez, ce que vous dites et ce que vous faites sont en harmonie.", author: "Mahatma Gandhi" },
        { text: "Il faut cultiver notre jardin.", author: "Voltaire" },
        { text: "Le plus grand bonheur que l'on puisse avoir est de savoir que l'on n'a pas nécessairement besoin du bonheur.", author: "William Saroyan" },
        { text: "Le bonheur est un parfum que l'on ne peut répandre sur les autres sans en recevoir quelques gouttes.", author: "Ralph Waldo Emerson" },
        { text: "Être heureux ne signifie pas que tout est parfait. Cela signifie que vous avez décidé de regarder au-delà des imperfections.", author: "Aristote" },
        { text: "Le bonheur n'est pas une destination, c'est une façon de voyager.", author: "Margaret Runbeck" },
        { text: "La joie de vivre est une émotion contagieuse.", author: "Diderot" },
        { text: "Chaque sourire te rend un jour plus jeune.", author: "Proverbe chinois" }
    ],
    'peace': [
        ...
        { text: "Si tu veux la paix, prépare la paix.", author: "Spinoza" },
        { text: "La paix n'est pas l'absence de guerre, c'est une vertu, un état d'esprit, une volonté de bienveillance.", author: "Baruch Spinoza" },
        { text: "Quand le pouvoir de l'amour surpassera l'amour du pouvoir, le monde connaîtra la paix.", author: "Jimi Hendrix" },
        { text: "La paix est le seul combat qui vaille la peine d'être mené.", author: "Albert Camus" },
        { text: "Personne ne peut vous apporter la paix, à part vous-même.", author: "Ralph Waldo Emerson" },
        { text: "La haine est un fardeau trop lourd à porter.", author: "Martin Luther King" },
        { text: "Se venger, c'est se mettre au niveau de son ennemi ; pardonner, c'est le dépasser.", author: "Francis Bacon" },
        { text: "Un monde en paix est un monde où l'on s'accepte.", author: "Anonyme" }
    ]
};
